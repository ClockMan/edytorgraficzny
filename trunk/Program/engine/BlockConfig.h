...
class BlockConfig
{
	...
	public:
		...
		/**
		 * Dodaje obiekt typu string (aTyp) na liste pod nazwa aName.
		 * @param aName nazwa pod jaka obiekt ma widniesc na liscie
		...
		/**
		 * Dodaje obiekt typu Boolean (aTyp) na liste pod nazwa aName.
		 * @param aName nazwa pod jaka obiekt ma widniesc na liscie
		 * @param aValue dane jakie maja zostac wrzucone na liste
		 * @return zwraca true jesli obiekt zostal dodany
		 */
		...
		/**
		 * Dodaje obiekt typu int (aTyp) na liste pod nazwa aName.
		 * @param aName nazwa pod jaka obiekt ma widniesc na liscie
		 * @param aValue dane jakie maja zostac wrzucone na liste
		 * @return zwraca true jesli obiekt zostal dodany
		 */
		...
		/**
		 * Dodaje obiekt typu double (aTyp) na liste pod nazwa aName.
		 * @param aName nazwa pod jaka obiekt ma widniesc na liscie
		 * @param aValue dane jakie maja zostac wrzucone na liste
		 * @return zwraca true jesli obiekt zostal dodany
		 */
		...
		/**
		 * Dodaje obiekt typu TBitmap (aTyp) na liste pod nazwa aName.
		 * @param aName nazwa pod jaka obiekt ma widniesc na liscie
		 * @param aValue dane jakie maja zostac wrzucone na liste
		 * @return zwraca true jesli obiekt zostal dodany
		 */
		...
		/**
		 * Dodaje obiekt typu TStream (aTyp) na liste pod nazwa aName.
		 * @param aName nazwa pod jaka obiekt ma widniesc na liscie
		 * @param aValue dane jakie maja zostac wrzucone na liste
		 * @return zwraca true jesli obiekt zostal dodany
		 */
